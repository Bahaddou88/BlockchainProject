...
contract MyImmobilierContract
{
    ...
    //get land details of an account
        function getImmobilier(address _Holder, uint _index) public view returns (string memory,uint,address,uint)
        {
            return (
            __ownerImmobiliers[_Holder][_index].N_titre,
            __ownerImmobiliers[_Holder][_index].price,
            __ownerImmobiliers[_Holder][_index].ownerAddress,
            __ownerImmobiliers[_Holder][_index].ID,
            );
